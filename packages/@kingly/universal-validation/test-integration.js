 ...
 * Tests the @kingly/universal-validation package integration
 */

import { UniversalValidationSystem } from './src/index.js';

async function testCorePackageIntegration() {
  console.log('🧪 Testing @kingly/universal-validation core package integration...\n');
  ...
  try {
    ...
    console.log('7. Testing @kingly/debug integration...');
    // The debug integration is automatic through imports, so we check if operations completed without errors
    console.log('✅ All operations completed with @kingly/debug integration active\n');
    ...
    console.log('\n🚀 @kingly/universal-validation is ready for core package integration!');
