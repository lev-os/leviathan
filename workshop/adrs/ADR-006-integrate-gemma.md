# ADR-006: Integrate gemma into Kingly Ecosystem
...
Through the Workshop LLM-First Intake System analysis, gemma has been identified as a high-priority implementation candidate for integration into the Kingly ecosystem.
...
**DECISION**: Integrate gemma into Kingly ecosystem

**REASONING**: Efficient language model for resource-constrained environments
...
### **Integration Value**
Lightweight LLM deployment and edge computing capabilities
...
- [gemma Repository](https://github.com/google-deepmind/gemma)
